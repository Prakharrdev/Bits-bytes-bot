...
The following text messages were sent in the meeting's voice channel text chat during the meeting. Use these for additional context:
...
2. **Speaker identification**: Use voice characteristics to distinguish speakers. Label them using the known participant names where possible. If you cannot identify a speaker, use "Speaker 1", "Speaker 2", etc.
